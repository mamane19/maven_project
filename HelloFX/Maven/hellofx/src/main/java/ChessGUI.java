	...
	public void drawBoard(GridPane b) {
		...
		for (int i = game.getRankSize() - 1; i >= 0; i--) {
			for (int j = game.getFileSize() - 1; j >= 0; j--) {
				...
				case King:
					picture = pieceColor ? "/static/pictures/WhiteKing.png" : "/static/pictures/BlackKing.png";
					break;
				case Queen:
					picture = pieceColor ? "/static/pictures/WhiteQueen.png" : "/static/pictures/BlackQueen.png";
					break;
				case Princess:
					picture = pieceColor ? "/static/pictures/WhitePrincess.png" : "/static/pictures/BlackPrincess.png";
					break;
				case Rook:
					picture = pieceColor ? "/static/pictures/WhiteRook.png" : "/static/pictures/BlackRook.png";
					break;
				case Bishop:
					picture = pieceColor ? "/static/pictures/WhiteBishop.png" : "/static/pictures/BlackBishop.png";
					break;
				case Knight:
					picture = pieceColor ? "/static/pictures/WhiteKnight.png" : "/static/pictures/BlackKnight.png";
					break;
				case Pawn:
					picture = pieceColor ? "/static/pictures/WhitePawn.png" : "/static/pictures/BlackPawn.png";
					break;
				default:
					picture = null;
					break;
